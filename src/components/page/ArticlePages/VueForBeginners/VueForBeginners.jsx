...
const VueForBeginners = () => (
  <div className="Global__page-width article-main-wrap">
    ...
    <img alt="vue-for-beginners" className="article-vue" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Vue.js_Logo_2.svg/1920px-Vue.js_Logo_2.svg.png" />
  ...
  It is also important to understand that we can call functions within other functions inside of our methods object. Like with data, we have to reference ‘this’ and add .otherFunction() to it. Here is an example which adds to our existing code base.
    ...
    <iframe title="embed1" src="https://codesandbox.io/embed/50njmzy69p" style={{ width: '100%' }} sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin" />
...
export default VueForBeginners;

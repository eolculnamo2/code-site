...
const ScalableJS = () => (
  <div className="Global__page-width article-main-wrap">
    ...
    <img alt="scalable javascript" className="article-scalable" src="https://images.pexels.com/photos/249798/pexels-photo-249798.png?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" />
    ...
    <iframe title="frame1" src="https://codesandbox.io/embed/4lqr7lmk30" style={{ width: '100%' }} sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin" />
